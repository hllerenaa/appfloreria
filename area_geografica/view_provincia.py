        ...
        if 'action' in request.GET:
            ...
            if action == 'add':
                if can_add:
                    ...
                    messages.error(request, "No tienes permisos para agregar países")
                    return redirect(redirectAfterPostGet(request))
            elif action == 'change':
                if can_change:
                    ...
                    messages.error(request, "No tienes permisos para modificar países")
                    return redirect(redirectAfterPostGet(request))
            elif action == 'ver':
                if can_view:
                    pk = int(request.GET['pk'])
                    ...
                    messages.error(request, "No tienes permisos para ver países")
                    return redirect(redirectAfterPostGet(request))
        if can_view:
            ...
            messages.error(request, "No tienes permisos para ver provincias")
            return redirect('/')