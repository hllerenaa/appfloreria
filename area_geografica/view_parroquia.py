        ...
        if 'action' in request.GET:
            ...
            if action == 'add':
                if can_add:
                    ...
                    messages.error(request, "No tienes permisos para agregar {}".format(titulo))
                    return redirect(redirectAfterPostGet(request))
            elif action == 'change':
                if can_change:
                    ...
                    messages.error(request, "No tienes permisos para modificar {}".format(titulo))
                    return redirect(redirectAfterPostGet(request))
            elif action == 'ver':
                if can_view:
                    pk = int(request.GET['pk'])
                    ...
                    messages.error(request, "No tienes permisos para ver {}".format(titulo))
                    return redirect(redirectAfterPostGet(request))
