...
def confiFaq(request):
    ...
    model = Configuracion
    Formulario = ConfiguracionFaqForm
    ...
    if request.method == 'POST':
        ...
        if can_view:
            ...
            data["pk"] = confi.pk
            return render(request, 'seguridad/configuracion/form_faq.html', data)
        else:
            return redirect('/')
