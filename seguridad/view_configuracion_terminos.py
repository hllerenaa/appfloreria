...
def confiTerminos(request):
    ...
    model = Configuracion
    Formulario = ConfiguracionTerminosForm
    ...
    if request.method == 'POST':
        ...
        if can_view:
            ...
            data["pk"] = confi.pk
            return render(request, 'seguridad/configuracion/form_terminos.html', data)
        else:
            return redirect('/')
