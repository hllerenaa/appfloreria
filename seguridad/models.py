...
class Configuracion(models.Model):
    ...
    tokentelegram = models.CharField(max_length=1000, blank=True, null=True, verbose_name='Token Telegram')
    urlmoodle = models.URLField(max_length=5000, blank=True, null=True, verbose_name='Enlace Moodle')
    keymoodle = models.CharField(default='', max_length=500, blank=True, null=True, verbose_name=u'Key Moodle')
