...
def redessocialesView(request):
    ...
    if request.method == 'POST':
        ...
        if 'action' in request.GET:
            ...
            if action == 'add':
                if can_add:
                    ...
                    return render(request, 'mantenimiento/redessociales/form.html', data)
                else:
        ...
        if can_view:
            ...
            return render(request, 'mantenimiento/redessociales/listado.html', data)
        else:
            messages.error(request, "No tienes permisos para ver {}".format(data["titulo"]))
            return redirect('/')